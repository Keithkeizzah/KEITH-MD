      ...
      return m.reply("Only my owner or Keithkeizzah can execute this command 🚫", null, {
        contextInfo: {
          externalAdReply: {
            ...
            title: "Only my owner or Keithkeizzah can execute this command 🚫",  // Set the error message as the title
            thumbnailUrl: "https://i.imgur.com/XlQIFIF.jpeg",  // Thumbnail image
            mediaType: 1,
